...
public class VanDongVien {
	...
	public static void hienThi(String[] str, int[][] a) {
		...
		for (int i = 0; i < a.length; i++) {
			System.out.printf("%-3d %-9s %5d %5d %5d %5d %n", (i + 1), str[i], a[i][0], a[i][1], a[i][2], tongTT(i));
		}
	}
	...
	public static void luaChon2() {	
		...
		System.out.printf("%-3d %-9s %5d %5d %5d %5d %n", (chiSo + 1), str[chiSo], a[chiSo][0], a[chiSo][1], a[chiSo][2], tongTT(chiSo));
	}
